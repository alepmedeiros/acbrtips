...
type
  ...
  private
    function AddTexto(Value: String): TForm1;
  public
    { Public declarations }
  end;
...
function TForm1.AddTexto(Value: String): TForm1;
begin
  REsult := SElf;
...
begin
  ...
  .AddTexto('</ce><e>Academia do Codigo</e>')
  .AddTexto('www.clubedosprogramadores.com.br')
  .AddTexto('2299999999')
  ...
  begin
    AddTexto(
        PadSpace(
             ClientDataSet1codigo.AsInteger.ToString+'|'+
             ClientDataSet1descricao.AsString+'|'+
             FormatFloatBr(msk6x3,ClientDataSet1quantidade.AsCurrency)+'|'+
             FormatFloatBr(msk7x2, ClientDataSet1valorunitario.AsCurrency)+'|'+
             FormatFloatBr(msk7x2, ClientDataSet1total.AsCurrency)+'|',
              ACBrPosPrinter1.ColunasFonteNormal, '|'));
    lTotal := lTotal + ClientDataSet1total.AsCurrency;
    ClientDataSet1.Next;
  end;
  ...
  .AddTexto(PadSpace('Qtd. Total de itens|'+ClientDataSet1.FieldCount.ToString,
            ACBrPosPrinter1.ColunasFonteNormal,'|'))
  .AddTexto(PadSpace('Valor Total|'+'R$ '+FormatFloatBr(msk7x2, lTotal),
            ACBrPosPrinter1.ColunasFonteNormal,'|'))
  .AddTexto('</linha_simples>')
  .AddTexto('')
  .AddTexto(PadSpace('FORMA DE PAGAMENTO|VALOR',
            ACBrPosPrinter1.ColunasFonteNormal,'|'))
  .AddTexto('<n>')
  .AddTexto(PadSpace('DINHEIRO|' + FormatFloatBr(msk7x2, lTotal),
            ACBrPosPrinter1.ColunasFonteNormal,'|'))
  .AddTexto('</n>')
